...
- [How to use spexial with jit, vmap and grad](use-with-jit-vmap-and-grad.md) — broadcasting, static integer parameters, and the one gradient you should not trust.
